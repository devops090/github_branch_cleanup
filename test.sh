execfunction () { 
  ...
  while IFS=',' read -r f1 f2; do
      ...
      dateformat=$(curl -u devops090:e952d0879410a1958c31fef0dcd24e443dd9be7e  -X GET https://api.github.com/repos/devops090/"$name_repo"/commits/"$name_branch" | grep "date" | sed 's/date/'"$name_repo"','"$name_branch"'/g' | sed s/\"//g | sed 's/:/,/g' | sed 's/ //g' | head -n1)
